  ...
  const contactInfo = [
    {
      ...
      title: 'Phone Numbers',
      details: [
        '+256752630101 (Main Office)',
        '+256 774 222898 (Admissions)',
        '+256 774 222898 (Director)'
      ]
    },
    {
      icon: '✉️',
      ...
      details: [
        'aishagayaza@gmail.com',
        'entebbeparentsss@gmail.com',
        'andrewkaggwaw@gmail.com'
      ]
    },
    {
      icon: '📍',
  ...
  <div className="map-container">
    ...
    <div className="map-info">
      ...
      <div className="directions-info">
        ...
        <ul>
          <li>From Kampala: Take Entebbe Road towards Entebbe town (About 1hr)</li>
          <li>Stop at Shell Petrol Station Entebbe town</li>
          <li>Take a boda or walk towards Education Center Primary School</li>
          <li>The school gate is just opposite Education Center Primary School</li>
        </ul>
      </div>
      ...
      <div className="emergency-section">
        ...
        <div className="emergency-grid">
          <div className="emergency-card">
            ...
            <p className="emergency-number">+256 774 222898</p>
